...
def calculate_actual_route_distance(route_nodes):
    ...
    for i in range(len(route_nodes) - 1):
        ...
        current_row = dc3_df[
            dc3_df[STORE_COL] == current_store
        ].iloc[0]

        next_row = dc3_df[
            dc3_df[STORE_COL] == next_store
        ].iloc[0]
...
print("\nGenerated File:")
print("dc3_milk_run_routes.xlsx")
