...
def calculate_actual_route_distance(route_nodes):
    ...
    for i in range(len(route_nodes) - 1):
        ...
        current_row = dc5_df[
            dc5_df[STORE_COL] == current_store
        ].iloc[0]

        next_row = dc5_df[
            dc5_df[STORE_COL] == next_store
        ].iloc[0]
...
print("\nGenerated File:")
print("dc5_milk_run_routes.xlsx")
